...
const INDUSTRIALRELATIONSL = () => {
  const [page, setPage] = useState(1);
  const fetchPanets = async (page) => {
    console.log(page);
    const result = await fetch(`/api/INDUSTRIALRELATIONS?page=${page}`);
    return result.json();
  };
          ...
          <div className="row">
            <div className="col-lg-12">
              <h2 style={{ color: "white" }}>
                <a>INDUSTRIAL RELATIONS PROJECT TOPICS AND MATERIALS</a>
              </h2>
