...
import THEOLOGYModel from "../../components/models/THEOLOGY";
import parser from "html-react-parser";

const THEOLOGYL = ({ post }) => {
  return (
    <div>
...
export default THEOLOGYL;

export async function getServerSideProps(context) {
  await dbConnect();

  let post = await THEOLOGYModel.find({ _id: context.params.id });
