...
import CHEMICALModel from "../../components/models/CHEMICAL";
import parser from "html-react-parser";

const CHEMICALL = ({ post }) => {
  return (
    <div>
...
export default CHEMICALL;

export async function getServerSideProps(context) {
  await dbConnect();

  let post = await CHEMICALModel.find({ _id: context.params.id });
