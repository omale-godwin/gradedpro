...
import COMPUTERENGModel from "../../components/models/COMPUTERENG";
import parser from "html-react-parser";

const COMPUTERENGS = ({ post }) => {
  return (
    <div>
...
export default COMPUTERENGS;

export async function getServerSideProps(context) {
  await dbConnect();

  let post = await COMPUTERENGModel.find({ _id: context.params.id });
