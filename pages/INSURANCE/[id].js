...
import INSURANCEModel from "../../components/models/INSURANCE";
import parser from "html-react-parser";

const INSURANCEL = ({ post }) => {
  return (
    <div>
...
export default INSURANCEL;

export async function getServerSideProps(context) {
  await dbConnect();

  let post = await INSURANCEModel.find({ _id: context.params.id });
