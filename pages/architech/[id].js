...
import ArchitechModel from "../../components/models/architect";
import parser from "html-react-parser";

const ArchitechS = ({ post }) => {
  return (
    <div>
...
export default ArchitechS;

export async function getServerSideProps(context) {
  await dbConnect();

  let post = await ArchitechModel.find({ _id: context.params.id });
