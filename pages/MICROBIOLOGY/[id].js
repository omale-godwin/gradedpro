...
import MICROBIOLOGYModel from "../../components/models/MICROBIOLOGY";
import parser from "html-react-parser";

const MICROBIOLOGYL = ({ post }) => {
  return (
    <div>
...
export default MICROBIOLOGYL;

export async function getServerSideProps(context) {
  await dbConnect();

  let post = await MICROBIOLOGYModel.find({ _id: context.params.id });
