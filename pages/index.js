    ...
    <img src='https://placekitten.com/400/300'/>
      ...
      <div className="row justify-content-center">
        <div className="col-auto">
          <button className=" m-3 btn text-center btn-primary" href="/">View All Project By Department</button>
        </div>
      </div>
        ...
        <div className="container">
            <div className="row ">
                <div className="col-sm-6 col-lg-4">
                    ...
                    <Link href="/acounting/Accounting"><a>ACCOUNTING PROJECTS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link href="/"><a>APPLIED SCIENCE</a></Link>
                     </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/artchitecture/architech"><a>ARCHITECTURE PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/Agriculture/Agriculture"><a>AGRICULTURAL SCIENCE PROJECT</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/BankingandFinance/BankingandFinance"><a>BANKING AND FINANCE</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/Biochemistry/Biochemistry"><a>BIOLOGY PROJECT TOPICS</a></Link>
                  </h2>
            ...
            <div className="row">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/Building/Building"><a>BUILDING TECHNOLOGY</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/BusinessAdministrationandManagement/BusinessAdministrationandManagement"><a>BUSINESS ADMINISTRATION PROJECT MATERIAL</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/Biochemistry/Biochemistry"><a>BIO-CHEMISTRY PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/CHEMISTRY/CHEMISTRY"><a>CHEMISTRY</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/chemical_engineering/ChemicalEngineering"><a>CHEMICAL ENGINEERING</a></Link>
                  </h2>
                  <p>These are Chemical Engineering Science department project topics with available well written chapters 1 to chapter 5, Please click on a project topic to view its details and order for the complete material</p>
             </div>
                </div>
                ...
                <div className="service-content">
                  <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/CivilEngineering/CivilEngineering"><a>CIVIL ENGINEERING PROJECT TOPICS</a></Link>
                  </h2>
            ...
            <div className="row ">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/computer/computer/"><a>COMPUTER SCIENCE PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/COMPUTERENGINEERING/COMPUTERENGINEERING"><a>COMPUTER ENGINEERING</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/COMMERCE/COMMERCE"><a>COMMERCE</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/CooperativeEconomic/CooperativeEconomic"><a>CO-OPERATIVE ECONOMIC PROJECT TOPIC</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/CRIMINOLOGY/CRIMINOLOGY"><a>CRIMINOLOGY AND SECURITY STUDIES Project Topics and Materials</a></Link>
                  </h2>
                  <p>CRIME CASE REPORTING AND THE OBSERVABLE IMPACT ON ITS VICTIMS | CONFESSIONAL STATEMENT UTILITY IN CRIMINAL TRIALS .. </p>
               </div>
                </div>
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/Economics/Economics"><a>ECONOMICS PROJECT TOPIC & MATERIALS</a></Link>
                  </h2>
            ...
            <div className="row">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/Education/Education"><a>EDUCATION PROJECT TOPICS AND MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/ELECTRICAL/ELECTRICAL"><a>ELECTRICAL & ELECTRONICS ENGINEERING</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/ENGLISH/ENGLISH"><a>ENGLISH LANGUAGE & LITERATURE</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/FineandAppliedArts/FineandAppliedArts"><a>FINE & APPLIED ART</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/ENTREPRENEURSHIP/ENTREPRENEURSHIP"><a>ENTREPRENEURSHIP PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/accountings/"><a>ENVIRONMENTAL SCIENCE</a></Link>
                  </h2>
            ...
            <div className="row">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/accountings/"><a>ENVIRONMENTAL SCIENCE PROJECT MATERIALS</a></Link>
                  </h2>
                  <p>These are Enviromental Science department project topics with available well written chapters 1 to chapter 5, Please click on a project topic to view its details and order for the complete material</p>    </div>
               </div>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/accountings/"><a>ESTATE MANAGEMENT PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/FisheryandAquacultur/FisheryandAquacultur"><a>FISHERIES AND AQUACULTURE PROJECTS</a></Link>
                  </h2>
                  <p>These are Biology Science department project topics with available well written chapters 1 to chapter 5, Please click on a project topic to view its details and order for the complete material</p>    </div>
              </div>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/FoodTechnology/FoodTechnology"><a>FOOD TECHNOLOGY</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/Geography/Geography"><a>GEOGRAPHY PROJECTS MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/GEOLOGY/GEOLOGY"><a>GEOLOGY</a></Link>
                  </h2>
                  <p>These are Geography department project topics with available well written chapters 1 to chapter 5, Please click on a project topic to view its details and order for the complete material</p>    </div>
              ...
              <div className="row">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/HISTORY/HISTORY"><a>HISTORY PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/HUMANRESOURCEMANAGEMENT/HUMANRESOURCEMANAGEMENT"><a>HUMAN RESOURCE MANAGEMENT</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/INSURANCE/INSURANCE"><a>INSURANCE PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/IndustrialChemistry/IndustrialChemistry"><a>INDUSTRIAL CHEMISTRY PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/IndustrialRelationsandPersonneManagement/IndustrialRelationsandPersonneManagement"><a>INDUSTRIAL RELATIONS & PERSON MANAGEMENT</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/LAW/LAW"><a>LAW PROJECT MATERIALS</a></Link>
                  </h2>
            ...
            <div className="row ">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/LIBRARYSCIENCE/LIBRARYSCIENCE"><a>LIBRARY SCIENCE PROJECTS MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/INTERNATIONALRELATIONS/INTERNATIONALRELATIONS"><a>INTERNATIONAL RELATIONS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/LINGUISTICSCOMMUNICATION/LINGUISTICSCOMMUNICATION"><a>LINGUISTICS & COMMUNICATION</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/MARKETING/MARKETING"><a>MARKETING PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/MedicalandHealthScience/MedicalandHealthScience"><a>MEDICAL & HEALTH SCIENCE</a></Link>
                  </h2>
                  <p>These are Library science department project topics with available well written chapters 1 to chapter 5, Please click on a project topic to view its details and order for the complete material</p>    </div>
               </div>
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/mass_comm/MassCommunication"><a>MASS COMMUNICATION</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/MATHEMATICS/MATHEMATICS"><a>MATHEMATICSPROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/MECHANICALENGINEERING/MECHANICALENGINEERING"><a>MECHANICAL ENGINEERING PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/MedicalandHealthScience/MedicalandHealthScience"><a>MEDICAL & HEALTH SCIENCE PROJECT</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/LIBRARYSCIENCE/LIBRARYSCIENCE"><a>LIBRARY SCIENCE PROJECT TOPICS</a></Link>
                  </h2>
                  <p>These are Library science department project topics with available well written chapters 1 to chapter 5, Please click on a project topic to view its details and order for the complete material</p>    </div>
                </div>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/MICROBIOLOGY/MICROBIOLOGY"><a>MICROBIOLOGY PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/NURSING/NURSING"><a>NURSING PROJECT MATERIALS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/OFFICETECHNOLOGYMANAGEMENT/OFFICETECHNOLOGYMANAGEMENT"><a>OFFICE TECHNOLOGY MANAGEMENT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PHARMACEUTICALSCIENCES/PHARMACEUTICALSCIENCES"><a>PHARMACEUTICAL SCIENCES TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PHILOSOPHY/PHILOSOPHY"><a>PHILOSOPHY PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PHYSICS/PHYSICS"><a>PHYSICS PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/POLITICALSCIENCE/POLITICALSCIENCE"><a>POLITICAL SCIENCE PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PSYCHOLOGY/PSYCHOLOGY"><a>PSYCHOLOGY PROJECT TOPICS</a></Link>
                  </h2>
            ...
            <div className="row ">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PUBLICADMINISTRATION/PUBLICADMINISTRATION"><a>PUBLIC ADMINISTRATION PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PUBLICHEALTH/PUBLICHEALTH"><a>PUBLIC HEALTH PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PROJECTMANAGEMENT/PROJECTMANAGEMENT"><a>PROJECT MANAGEMENT </a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/PURCHASINGSUPPLYCHAINMANAGEMENT/PURCHASINGSUPPLYCHAINMANAGEMENT"><a>PURCHASING & SUPPLY CHAIN MANAGEMENT </a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/QUANTITYSURVEY/QUANTITYSURVEY"><a>QUANTITY SURVEY PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/SecretarialAdministration/SecretarialAdministration"><a>SECREATARIAL ADMINISTRATION TOPICS</a></Link>
                  </h2>
            ...
            <div className="row ">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/SCIENCELABORATORYTECHNOLOGY/SCIENCELABORATORYTECHNOLOGY"><a>SCIENCE LABORATORY TECHNOLOGY</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/SOCIOLOGY/SOCIOLOGY"><a>SOCIOLOGY PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/STATISTICS/STATISTICS"><a>STATISTICS PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/THEATREARTS/THEATREARTS"><a>THEATRE ARTS PROJECT TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/THEOLOGYBIBLICALSTUDIES/THEOLOGYBIBLICALSTUDIES"><a>THEOLOGY & BIBLICAL STUDIES TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/TransportManagement/TransportManagement"><a>TRANSPORT MANAGEMENT</a></Link>
                  </h2>
            ...
            <div className="row ">
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/accountings/"><a>URBAN & REGIONAL PLANNING TOPICS</a></Link>
                  </h2>
                ...
                <div className="col-sm-6 col-lg-4">
                    <div className="service-block-inner">
                    <h2 className="service-title">
                    <Link style={{color: '#c73176'}} href="/VETERINARYMEDICINE/VETERINARYMEDICINE"><a>VETERINARY MEDICINE PROJECT TOPICS</a></Link>
                  </h2>
